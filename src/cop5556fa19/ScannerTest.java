...
class ScannerTest {
    ...
    @Test
    void handleZeroDigitIntegerLiteratl() throws Exception {
        Reader r = new StringReader("9141613101210101013");
        Scanner s = new Scanner(r);

        int pos = 0;
        assertToken(s, INTLIT, "9141613131717171815", pos++);

    }

    @Test
    void handleZeroDigitIntegerLiteratt() throws Exception {
        Reader r = new StringReader("9141613131717171815");
